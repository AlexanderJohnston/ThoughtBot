...
namespace Realization
{
    public class Thalamus
    {
        ...
        private async Task TryRespondWithLoom(SocketMessage messageParam, SocketUserMessage? message, Guid memId, EmbeddedMemory embedding, ulong channelId)
        {
